...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field users on 'Instance'
        db.create_table('instances_instance_users', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('instance', models.ForeignKey(orm['instances.instance'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('instances_instance_users', ['instance_id', 'user_id'])


    def backwards(self, orm):
        # Removing M2M table for field users on 'Instance'
        db.delete_table('instances_instance_users')
