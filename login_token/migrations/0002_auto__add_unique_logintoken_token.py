...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'LoginToken', fields ['token']
        db.create_unique('login_token_logintoken', ['token'])


    def backwards(self, orm):
        # Removing unique constraint on 'LoginToken', fields ['token']
        db.delete_unique('login_token_logintoken', ['token'])
    ...
    models = {
        ...
        'login_token.logintoken': {
            ...
            'token': ('django.db.models.fields.TextField', [], {'default': "'philodendra lowed summon'", 'unique': 'True', 'max_length': '255'}),
