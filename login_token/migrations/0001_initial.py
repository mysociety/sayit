...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('login_token_logintoken', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('instance', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['instances.Instance'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('token', self.gf('django.db.models.fields.TextField')(default='aforethought unrealistic runabout', max_length=255)),
        ))
        db.send_create_signal('login_token', ['LoginToken'])


    def backwards(self, orm):
        # Deleting model 'LoginToken'
        db.delete_table('login_token_logintoken')
    ...
    models = {
        ...
        'login_token.logintoken': {
            ...
            'token': ('django.db.models.fields.TextField', [], {'default': "'enslaves slapped fingerprints'", 'max_length': '255'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        }
    }

    complete_apps = ['login_token']