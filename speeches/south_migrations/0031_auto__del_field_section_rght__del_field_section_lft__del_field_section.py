...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('speeches_section', 'rght')

        # Deleting field 'Section.lft'
        db.delete_column('speeches_section', 'lft')

        # Deleting field 'Section.level'
        db.delete_column('speeches_section', 'level')

        # Deleting field 'Section.tree_id'
        db.delete_column('speeches_section', 'tree_id')
