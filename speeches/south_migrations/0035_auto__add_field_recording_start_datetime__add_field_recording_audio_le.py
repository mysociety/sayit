...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Recording.start_datetime'
        db.add_column('speeches_recording', 'start_datetime',
    ...
    def backwards(self, orm):
        # Deleting field 'Recording.start_datetime'
        db.delete_column('speeches_recording', 'start_datetime')

        # Deleting field 'Recording.audio_duration'
        db.delete_column('speeches_recording', 'audio_duration')
