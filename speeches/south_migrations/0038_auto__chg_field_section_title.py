...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('speeches_section', 'title', self.gf('django.db.models.fields.CharField')(max_length=1024))

    def backwards(self, orm):

        # Changing field 'Section.title'
        db.alter_column('speeches_section', 'title', self.gf('django.db.models.fields.CharField')(max_length=255))
