...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('speeches_section', 'slug', self.gf('django.db.models.fields.SlugField')(default='', max_length=50))

    def backwards(self, orm):

        # Changing field 'Section.slug'
        db.alter_column('speeches_section', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50, null=True))
