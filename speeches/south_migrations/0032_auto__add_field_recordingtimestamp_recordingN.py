...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RecordingTimestamp.recordingN'
        db.add_column('speeches_recordingtimestamp', 'recordingN',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='timestamp', null=True, to=orm['speeches.Recording']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RecordingTimestamp.recordingN'
        db.delete_column('speeches_recordingtimestamp', 'recordingN_id')
    ...
    models = {
        ...
        'speeches.recordingtimestamp': {
            ...
            'instance': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['instances.Instance']"}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'recordingN': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'timestamp'", 'null': 'True', 'to': "orm['speeches.Recording']"}),
