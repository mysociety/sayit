...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Speech.celery_task_id'
        db.add_column('speeches_speech', 'celery_task_id',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Speech.celery_task_id'
        db.delete_column('speeches_speech', 'celery_task_id')
