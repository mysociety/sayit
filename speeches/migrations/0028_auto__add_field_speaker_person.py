...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('speeches_speaker', 'person',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['popit.Person'], null=True, on_delete=models.PROTECT, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Speaker.person'
        db.delete_column('speeches_speaker', 'person_id')
