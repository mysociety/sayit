...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RecordingTimestamp.speech'
        db.add_column('speeches_recordingtimestamp', 'speech',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['speeches.Speech'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RecordingTimestamp.speech'
        db.delete_column('speeches_recordingtimestamp', 'speech_id')
