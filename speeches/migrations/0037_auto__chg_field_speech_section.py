...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Speech.section'
        db.alter_column('speeches_speech', 'section_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['speeches.Section'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):

        # Changing field 'Speech.section'
        db.alter_column('speeches_speech', 'section_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['speeches.Section'], null=True))
