...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('speeches_section', 'slug',
                      self.gf('django.db.models.fields.SlugField')(max_length=50, null=True),
                      keep_default=False)

        # Adding unique constraint on 'Section', fields ['slug', 'parent']
        db.create_unique('speeches_section', ['slug', 'parent_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Section', fields ['slug', 'parent']
        db.delete_unique('speeches_section', ['slug', 'parent_id'])

        # Deleting field 'Section.slug'
        db.delete_column('speeches_section', 'slug')
