...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table('speeches_debate')

        # Deleting model 'Meeting'
        db.delete_table('speeches_meeting')

        # Deleting field 'Speech.debate'
        db.delete_column('speeches_speech', 'debate_id')


    def backwards(self, orm):
        # Adding model 'Debate'
        db.create_table('speeches_debate', (
            ...
            ('meeting', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['speeches.Meeting'], null=True, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('speeches', ['Debate'])

        # Adding model 'Meeting'
        db.create_table('speeches_meeting', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('instance', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['instances.Instance'])),
        ...
        db.send_create_signal('speeches', ['Meeting'])

        # Adding field 'Speech.debate'
        db.add_column('speeches_speech', 'debate',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['speeches.Debate'], null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'speeches.section': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'parent': ('mptt.fields.TreeForeignKey', [], {'blank': 'True', 'related_name': "'children'", 'null': 'True', 'to': "orm['speeches.Section']"}),
