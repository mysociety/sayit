...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Speech.speaker_display'
        db.add_column('speeches_speech', 'speaker_display',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Speech.speaker_display'
        db.delete_column('speeches_speech', 'speaker_display')
