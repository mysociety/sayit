...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Speech.section'
        db.add_column('speeches_speech', 'section',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['speeches.Section'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Speech.section'
        db.delete_column('speeches_speech', 'section_id')
