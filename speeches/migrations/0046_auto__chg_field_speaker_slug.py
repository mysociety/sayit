...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('speeches_speaker', 'slug', self.gf('sluggable.fields.SluggableField')(default='', unique_with=('instance',), max_length=50, populate_from='name'))

    def backwards(self, orm):

        # Changing field 'Speaker.slug'
        db.alter_column('speeches_speaker', 'slug', self.gf('sluggable.fields.SluggableField')(populate_from='name', unique_with=('instance',), max_length=50, null=True))
