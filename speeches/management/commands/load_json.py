...
from speeches.import_json import ImportJson
...
class Command(BaseCommand):
    option_list = BaseCommand.option_list + (
        ...
        make_option('--file', action='store', help='json document to import'),
        make_option('--dir',  action='store', help='directory of JSON documents to import'),
    ...
    def import_document(self, path, **options):
        ...
        an = ImportJson(instance = instance, commit = options['commit'])
